<template>
    <div>
        ...
        <el-descriptions title="设备基本信息" :size="medium">
        ...
        <el-table :data="tableData" stripe style="width: 100%" border :align="center">
            <el-table-column prop="properties" label="功能类型">
            </el-table-column>
            <el-table-column prop="name" label="功能名称">
            </el-table-column>
            <el-table-column prop="type" label="类型">
            </el-table-column>
            <el-table-column prop="accessmode" label="权限">
            </el-table-column>
            <el-table-column prop="defaultValue" label="数据定义">
            </el-table-column>
...
export default {
    ...
    data() {
        return {
            ...
            isok: false,
            tableData: [{properties:'属性',name:'power-status'}]
