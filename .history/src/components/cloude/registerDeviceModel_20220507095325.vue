    ...
    <div>
        ...
        <el-dialog title="提示" :visible.sync="dialogUploadFileVisible" width="60%">
            <div>
                ...
                <div>
                    <JsonEditor :value="initialJson"></JsonEditor>
                </div>
            </div>
...
<script>
import JsonEditorVue from "@/static/JsonEditor.vue";
import deviceModelVue from "@/static/deviceModel.vue";
//引入
import pubsub from 'pubsub-js'
import JsonEditor from "@/static/JsonEditor.vue";

export default {
    name: "registerDeviceModel",
    components: { deviceModelVue, JsonEditorVue, JsonEditor },
    beforeDestroy() {
