<template>
    <div>
            ...
            <el-row>
                <el-col :span="20">
                    <div style="float:left">
                        <el-button icon="el-icon-edit" type="primary" size="small" @click="addmodelstatus">自定义</el-button>
                    </div>
        ...
        <el-divider content-position="center"><i class="el-icon-s-order" style="fontsize:10px"</font>></i></el-divider>
